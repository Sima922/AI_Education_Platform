...
SECRET_KEY = "django-insecure-u((jm40!)8stkg_k=a0)-+359d+2owh*zl@s$3_9d5n0ieu4%w"
...
# IMPORTANT: Add these two lines to use your custom adapter
# settings.py

# IMPORTANT: Add these two lines to use your custom adapters
